...
For React projects, you can use the provided [`useStateDesigner`](/docs/useStateDesigner) hook to both create the machine and subscribe to its updates. The hook returns several items, including a method that you can use to send events to the machine.
