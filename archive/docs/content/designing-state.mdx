...
At present, both of these tasks—designing how the user interface should work, and then of implementation that solution—are almost always performed _together_ in code. However, the code we use to _manage_ state is often very poorly suited for _designing_ state.
