...
So far we've been learning to use State Designer in a regular JavaScript project. In the next article, we'll learn to use State Designer in a **React** project with the `useStateDesign` hook.
